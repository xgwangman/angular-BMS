...
export class JsplumbDemoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    instance.batch(function () {
      ...
      _addEndpoints("Window4", ["LeftMiddle", "RightMiddle"], ["TopCenter", "BottomCenter"]);
      _addEndpoints("Window2", ["LeftMiddle", "BottomCenter"], ["TopCenter", "RightMiddle"]);
      _addEndpoints("Window3", ["RightMiddle", "LeftMiddle"], ["BottomCenter", "TopCenter"]);
